...
def render_header():
    logo_path = os.path.join("image", "logo-300x88.png")
    ...
    with col2:
        st.markdown("""
            ...
            <p style='color: gray; margin-top: 5px;'>Controle de Produção - RACK MINI ADES</p>
        """, unsafe_allow_html=True)
...
def render_status_dobradeira(status_dobradeira):
    ...
    num_cols = 3  # Número de cards por linha
    rows = [
